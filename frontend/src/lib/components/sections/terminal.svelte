...
<div class="flex flex-col gap-1 py-2 h-full">
  ...
  <button
      ...
      class="flex items-center gap-1 text-xs text-print/50 hover:text-print border border-accent-detail/40 hover:border-accent-detail rounded-md transition-colors"
    >
