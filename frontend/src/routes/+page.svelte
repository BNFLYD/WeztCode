    ...
    {:else if activeSection === "settings"}
      <div class="space-y-4">
        <div class="flex flex-col gap-2">
          ...
          >
          <select
            class="w-full px-3 py-2 bg-back border border-accent rounded text-xs text-accent-warn outline-none"
          >
