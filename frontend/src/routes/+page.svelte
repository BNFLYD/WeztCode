    ...
    <div class="flex w-full justify-between px-4 py-2">
      {#each sections as section}
        <button
          ...
          section.id
            ? 'text-back ring-0.5 ring-accent/70 ring-offset-0 ring-offset-transparent bg-accent-detail bg-[radial-gradient(circle_at_center,theme(colors.accent/0.2)_0%,transparent_100%)] bg-blend-overlay'
            : 'text-back-deep'}"
