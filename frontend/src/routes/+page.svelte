...
<!-- Sidebar -->
<div class="h-[100vh] flex flex-col bg-back-deep rounded-l-3xl">
  ...
  >
    <div class="flex w-full justify-between px-4 py-2">
      {#each sections as section}
        <button
          ...
          section.id
            ? 'text-accent/25 shadow-[0_0_15px_rgba(0,255,221,0.6),0_0_30px_rgba(0,255,221,0.3)]'
            : 'text-back-deep'}"
    ...
    <div class="flex justify-center -mb-5">
      <span
        class="bg-back-deep px-2 text-sm font-sans tracking-[3px] text-print"
      >
